            ...
            <ul>
              ...
              <div class="row align-items-center ">
                <div class="col-7 text-start">
                  <li><a class="nav-link active anchorNav lead" href="{{route('user.profile', ['userId'=>Auth::user()->id])}}">Profilo</a></li>
                  <li><a class="nav-link active anchorNav lead" href="{{route('team.create')}}">Crea il tuo Team</a></li>
